...
class Product:
    ...
    def get_price(self):
        ...
        #Take the mean of the various prices of different order items per product id
    ...
    def get_product_cat(self, agg="mean"):
        ...
        column_list = [item for item in products.columns]
        del column_list[0]
        del column_list[7]
        del column_list[13]

        stringay_straaang = {}
        stringay_straaang['quantity'] = "sum"
        for item in column_list:
            stringay_straaang[item] = 'mean'
        stringay_straaang

        returnable = products.groupby('category').agg(stringay_straaang)
        return returnable
